import 'package:attendance_monitoring/api/apikey.dart';
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return ListTile(
                  ...
                  title: Text(textandImageChat[index]["role"]), //username=>role
                  subtitle: Text(textandImageChat[index]["text"]), //chat=>text
